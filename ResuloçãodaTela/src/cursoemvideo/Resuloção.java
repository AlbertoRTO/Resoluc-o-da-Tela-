 ...
 * @author s
 */
public class Resuloção extends javax.swing.JFrame {

    /**
     * Creates new form Resuloção
     */
    public Resuloção() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Resuloção do seu Monitor");

        lblResolucao.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblResolucao.setForeground(new java.awt.Color(0, 102, 204));
        lblResolucao.setText("Click no Botão");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Resuloção.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
